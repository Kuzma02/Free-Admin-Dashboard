...
const Sidebar = () => {
  ...
  const navActiveClass: string =
    "block dark:bg-whiteSecondary flex items-center self-stretch gap-4 py-4 px-6 cursor-pointer max-xl:py-3 dark:text-blackPrimary bg-blackPrimary text-whiteSecondary";

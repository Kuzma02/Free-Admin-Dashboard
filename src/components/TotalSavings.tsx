    ...
    <div className="dark:bg-gray-900 bg-whiteSecondary border border-blackPrimary px-5 py-3 mt-5">
      <div className="flex flex-col gap-1">
        ...
        <div className="mt-3 border-t border-gray-600">
          <SingleProgressElementTotalSavings title="Education" totalMoney={300} percentSaved={50} />
            <SingleProgressElementTotalSavings title="Health" totalMoney={150} percentSaved={70} />
            <SingleProgressElementTotalSavings title="Entertainment" totalMoney={160} percentSaved={30} />
            <SingleProgressElementTotalSavings title="Food" totalMoney={600} percentSaved={20} />
        </div>
      </div>
    </div>
  );

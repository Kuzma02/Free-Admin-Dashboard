const Welcome = () => {
  return (
    <div className="flex flex-col gap-y-4 py-7">
      <h3 className="text-whiteSecondary text-3xl font-bold">
      ...
      <button className="bg-whiteSecondary text-blackPrimary w-60 py-3 font-semibold text-lg hover:bg-white duration-200">
